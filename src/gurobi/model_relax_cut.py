...
class IntegratedGurobi:
    def __init__(self, instance, time_limit=None, init_solution=None, sita=3):
        ...
        # self.K = 1# 暂存区的最大储位
        self.T = self.instance.max_T # max t set
        self.sita = sita
        self.bigM = 100 # big M
...
if __name__ == "__main__":
    input_path = "/Users/xiekio/Desktop/研一/组会/毕设/My/O-T-A-S-in-IMTK-SRS/experiment/small_scale_experiment/myRandomInstanceGurobi0.json"
