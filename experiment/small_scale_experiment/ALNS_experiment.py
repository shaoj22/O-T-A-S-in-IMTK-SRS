...
column_name = ['ID', 'Order', 'Tote', 'Station', 'Block', 'Station_buffer', 'Block_storage', 'FCFS', 'CPU Time1', 'Greedy','CPU Time2', 'Gap1', 'ALNS', 'CPU Time3', 'Gap-F', 'Gap-G']
...
for i in range(20):
    ...
    new_date = [id, order, tote, station, block, station_buffer, block_storage, fcfs, cpu_time1, greedy, cpu_time2, gap1, alns, cpu_time3, gap_f, gap_g]
    df.loc[len(df.index)] = new_date
    excel_path = 'ALNS_Heurisitc_small_scale_solution.xlsx'
